...
const ControlSidebar = () => {
  ...
  const headerBorder = useSelector(
    (state: IRootState) => state.ui.headerBorder,
  );
  const headerFixed = useSelector((state: IRootState) => state.ui.headerFixed);
  const footerFixed = useSelector((state: IRootState) => state.ui.footerFixed);
  const navbarVariant = useSelector(
    (state: IRootState) => state.ui.navbarVariant,
  );
  const sidebarSkin = useSelector((state: IRootState) => state.ui.sidebarSkin);
  const layoutBoxed = useSelector((state: IRootState) => state.ui.layoutBoxed);
  const layoutFixed = useSelector((state: IRootState) => state.ui.layoutFixed);
  ...
  const menuSidebarCollapsed = useSelector(
    (state: IRootState) => state.ui.menuSidebarCollapsed,
  );
